...
#define e @"ICHuBtnuCWad2K9%2ByVphNeAny5QQPf30AVanMmswkxo%3D"
#define Play_SongLink_Url @"http://tingapi.ting.baidu.com/v1/restserver/ting?method=baidu.ting.song.getInfos&ts=%@&songid=%@&nw=2&l2p=344.1&lpb=320000&ext=MP3&format=json&from=ios&usup=1&lebo=0&aac=0&ucf=4&vid=&res=1&e=%@&version=5.5.0&from=ios&channel=appstore"
